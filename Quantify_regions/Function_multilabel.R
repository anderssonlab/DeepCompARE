...
universe <- "/maps/projects/ralab/people/pcr980/DeepCompare/Pd1_bed_processed/universe.bed"
...
derive_labels <- function(data_names,pos_list,loose_list,out_dir,out_prefix,
  ...
  if (quantification_type=="avg"){
    df_quantification <- quantify_signals(resize(gr, width=600, fix="center"),
    ...
    df_quantification <- quantify_3_nucleosomes(resize(gr, width=600, fix="center"),
                                                "/maps/projects/ralab/people/pcr980/DeepCompare/Quantify_regions/Quant_signal_processed")
  } else {
