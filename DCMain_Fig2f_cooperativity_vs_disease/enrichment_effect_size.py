...
sns.set(style="ticks", rc={"axes.spines.right": True, "axes.spines.top": True})
...
def main(trait, cell_line):
    ...
    sns.scatterplot(data=df_res, x="threshold", y="odds_ratio", color="orange")
    plt.errorbar(
        df_res["threshold"],
        df_res["odds_ratio"],
    ...
    plt.xlabel("Quantile of ISA threshold")
    ...
    plt.tick_params(
        ...
        direction="inout"    # Ticks both inside and outside the axis
    )
