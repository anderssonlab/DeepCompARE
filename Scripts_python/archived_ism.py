...
def calculate_ism_delta(*args):
    ...
    """
    if len([*args])==4:
        seq_file,seq_colname,out_path,device=args
        ...
        write_predictions(seq_file,
                          seq_colname,
                          os.path.join(dir_temp,"pred_ref.csv"),
                          device=device)
...
if __name__=="__main__":
    ...
    parser.add_argument('--device', type=str, help='GPU device number')
    args = parser.parse_args()
    calculate_ism_delta(args.seq_file,args.seq_colname,args.out_path,
