...
# python3 get_motif_df.py --file_name enhancers_k562 --device 4 &


# python3 get_motif_df.py --file_name resize_600bp_CAGE_HepG2  --device 4 &

python3 get_motif_df.py --file_name DNase_E118_hepg2  --device 0 &
python3 get_motif_df.py --file_name DNase_E123_k562   --device 1 &
