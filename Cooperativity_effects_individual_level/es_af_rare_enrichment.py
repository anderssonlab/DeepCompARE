...
#         "Enrichment analysis", color_mapping,
#         out_name="Plots/af_enrichment_not_matched.pdf",
#         ax=None) # Comparing to rest, subs are depleted in common

# df_matched=match_cell_type_specificity(df_tfbs_maf_es,df_dispersion)
# df_binned = df_matched.loc[:, ["AF_bin", "TF_type"]].copy().groupby(["AF_bin", "TF_type"]).size().unstack()
# df_plot= calc_or(df_binned, "AF_bin", "TF_type")
# plot_or(df_plot,"AF_bin", "odds_ratio", "TF_type",
#         "Enrichment analysis", {'redundant': "#1f77b4"},
